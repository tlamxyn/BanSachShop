        ...
        <div class="col-md-4">
            ...
            <form action="{{ route('admin.categories.update')}}" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input  id="my-input" required class="form-control" type="text" name="Ten" value="{{  $content->MaNCC }}">
                    <label  for="my-input" class="control-label" style="margin-top: 10px"> Tên Sản Phẩm </label>
                    <input  id="my-input" required class="form-control" type="text" name="Ten" value="{{  $content->TenNcc }}">
